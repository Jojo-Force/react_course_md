...
* createAsyncThunk的使用：reducer处理不同情况
...
![image-20260115145102568](1.assets/image-20260115145102568.png)

* 根据特性划分页面

![image-20260115145044934](1.assets/image-20260115145044934.png)

* 内部的管理系统不存在搜索引擎优化问题，适合客户端渲染。

![image-20260115150119852](1.assets/image-20260115150119852.png)

* 技术选型

![image-20260115150230580](1.assets/image-20260115150230580.png)
...
![image-20260115160028336](1.assets/image-20260115160028336.png)



* styled components的组件化使用方法
...
* Supabase: 一个开源的 **Firebase 替代方案**，它基于 **PostgreSQL 数据库** 构建，提供了一套现代化的后端即服务（BaaS, Backend-as-a-Service）工具，帮助开发者快速构建全栈应用，而无需从零搭建服务器。
